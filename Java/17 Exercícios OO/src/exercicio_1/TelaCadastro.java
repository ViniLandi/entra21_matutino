...
public class TelaCadastro extends JFrame {
	...
	private JTable tabela_jogos;
	Jogo Jogo;
	private JTable tabela_plataforma;
	private JTable tabela_genero;
	...
	private Jogo jogo() {
		Jogo j = new Jogo();
		j.setNome_jogo(txtNome.getText().toUpperCase());
		j.setGenero_jogo(txtGenero.getText().toUpperCase());
		j.setPlataforma_jogo(txtPlataforma.getText().toUpperCase());
		j.setClassificacao_jogo(Integer.parseInt(txtClassificacao.getText()));
		j.setValor_jogo(Double.parseDouble(txtValor.getText()));
	...
	private Plataforma plataforma() {
		...
		p.setNomePlataforma(txtPlataforma.getText().toUpperCase());
		p.setQuantidadePlataforma(p.getQuantidadePlataforma());
	...
	private Genero genero() {
		Genero g = new Genero();
		g.setNomeGenero(txtGenero.getText().toUpperCase());
		g.setQuantidadeGenero(g.getQuantidadeGenero());
	...
	public TelaCadastro() {
		...
		tabela_jogos.setModel(Acoes.selecao());
		...
		btnCadastrar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (CamposVazios() == false) {
					...
					Acoes.Cadastro_jogo(jogo(), plataforma(), genero());
					tabela_jogos.setModel(Acoes.selecao());
					LimpaCampos();
				}else {
