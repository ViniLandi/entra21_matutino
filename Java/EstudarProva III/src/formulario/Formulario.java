...
public class Formulario extends JFrame {
	...
	private JButton btnEstatsticas;
	public static String IMC_auxiliar;
	...
	public Formulario() {
		...
		btnCadastrar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				tabela_usuario.setModel(Acao.RetornaTabelaUsuario());
				LimpaCampos();
			}
		});
		...
		btnAlterar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				IMC_auxiliar = tabela_usuario.getValueAt(tabela_usuario.getSelectedRow(), 4).toString();
			}
		});
		...
		btnEstatsticas.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				estatisticas.setTabela_IMC(Acao.RetornaTabelaIMC());
				estatisticas.setVisible(true);
			}
		});
		btnEstatsticas.setFont(new Font("Tahoma", Font.PLAIN, 11));
		btnEstatsticas.setBounds(10, 132, 188, 23);
