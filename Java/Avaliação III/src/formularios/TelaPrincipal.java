	...
	public TelaPrincipal() {
		...
		cbxCargo.addItemListener(new ItemListener() {
			public void itemStateChanged(ItemEvent e) {
				if (cbxCargo.getSelectedItem().equals("Estagiário")) {
				...
				}else if (cbxCargo.getSelectedItem().equals("Desenvolvedor Sênior")) {
				...
				}else if (cbxCargo.getSelectedItem().equals("Analista de sistemas Sênior")) {
