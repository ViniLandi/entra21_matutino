...
public class Formulario extends JFrame {
	...
	public Formulario() {
		...
		lblQuantidade.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				JOptionPane.showMessageDialog(null,
						...
						"Violão x "+Dados.produto.getViolao()+"\n"+
		...
		lblQuantidade.setBounds(297, 28, 147, 63);
		...
		separator_1.setBounds(89, 142, 2, 201);
		contentPane.add(separator_1);
		
		JSeparator separator_2 = new JSeparator();
		separator_2.setOrientation(SwingConstants.VERTICAL);
		separator_2.setBounds(209, 142, 2, 201);
		contentPane.add(separator_2);
		
		JSeparator separator_3 = new JSeparator();
		separator_3.setOrientation(SwingConstants.VERTICAL);
		separator_3.setBounds(324, 142, 2, 201);
